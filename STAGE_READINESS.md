...
| 11 | Audio device reconnect handled gracefully | ⚠️ | Written 2026-08-20, **never exercised** — no interface has been unplugged from a running GhostBand. `core::DeviceRecovery` is tested (60 checks); the JUCE wiring is not |
